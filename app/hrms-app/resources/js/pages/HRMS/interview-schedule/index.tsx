...
import InterviewScheduleDataTable, {
  type InterviewScheduleItem,
} from '@/components/HRMS/interview-schedule/interview-schedule-data-table';
...
export default function InterviewSchedule() {
  ...
  const items: InterviewScheduleItem[] = [
    ...
    },
    {
      ...
      interviewers: [{ id: 'u3', name: 'Mark Lee' }],
    ...
    },
    {
      ...
      status: 'completed',
      interviewType: 'phone',
      interviewers: [{ id: 'u4', name: 'Tom Alvarez' }],
      feedbackStatus: 'submitted',
      updatedAt: new Date().toISOString(),
    },
    {
      ...
      status: 'invited',
      interviewType: 'video',
      interviewers: [{ id: 'u5', name: 'Nina Patel' }],
      feedbackStatus: 'none',
      updatedAt: new Date().toISOString(),
    },
    {
      ...
      interviewType: 'video',
      interviewers: [{ id: 'u6', name: 'Sara Johnson' }],
      feedbackStatus: 'pending',
      updatedAt: new Date().toISOString(),
    },
    {
      ...
      status: 'no_show',
      interviewType: 'video',
      interviewers: [{ id: 'u7', name: 'Helen Park' }],
      feedbackStatus: 'none',
      updatedAt: new Date().toISOString(),
    },
    {
      ...
      status: 'cancelled',
      interviewType: 'in_person',
      interviewers: [{ id: 'u8', name: 'Akira Tanaka' }],
      feedbackStatus: 'none',
      updatedAt: new Date().toISOString(),
    },
  ];
