...
class JobPostingController extends Controller
{
    ...
    {
        return Inertia::render('HRIS/job-posting/action');
    }
    ...
    public function show(string $id): Response
    {
        ...
        $applicants = [
            [
                ...
                'status' => 'in_review',
                'resumeScore' => 86,
                'profileUrl' => url("/HRIS/applicant/A-50001"),
            ...
            [
                ...
                'status' => 'new',
                'resumeScore' => 78,
                'profileUrl' => url("/HRIS/applicant/A-50002"),
            ...
            [
                ...
                'status' => 'in_review',
                'resumeScore' => 92,
                'profileUrl' => url("/HRIS/applicant/A-50003"),
            ...
            [
                ...
                'status' => 'new',
                'resumeScore' => 74,
                'profileUrl' => url("/HRIS/applicant/A-50004"),
        ...
        return Inertia::render('HRIS/job-posting/detail', [
            'jobPosting' => $posting,
        ]);
    }
